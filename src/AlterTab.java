...
public class AlterTab extends HttpServlet 
{
	...
	public void doPost(HttpServletRequest req, HttpServletResponse res)
		...
		//Redirecting to login page when Session TimedOut
                if(session == null) {
				...
				for(int x=0;x<prevColumnNames.length;x++) {
					...
					//Existing Column
						...
						break;
                                ...
                                //Modifications for existing Column
				if(prevFound) {
                                        ...
                                        if(prevAction == 1) {
                                        	...
                                        	if(dbProductName.equals("ACCESS")){
                            					 modify =	"ALTER TABLE  "+ tableName +" alter COLUMN "+colname +" "+coltype;
                                				
                                			}else{
						 modify = "alter table " + tableName + 
						...
						//Column declared as both unique and not null
			...
			//Successful Connection
				...
				if(errorIndex.size() == 0) {
					...
					//Updating metadata and resultset
                                        try {
						dbMetaData = connection.getMetaData();
						resultSet  = dbMetaData.getTypeInfo();
						typeNames  = new Vector();
                                                //Retreing types available for database
			...
			if(error_occured)	{
				...
				writer.close();
                        ...
                        //Displaying errors and queries which caused them
