	...
	public void doGet(HttpServletRequest req, HttpServletResponse res)
		...
		if(session == null) {
			...
			try {
				...
				//Updating resultset with all types supported by database
				...
				if(schemaValue == 0)	resultSet = dbMetaData.getTables(schema,null,null,types);
                                ...
                                //Iterating resulset and retreiving table info
			...
			if(!error_occured) {
				...
				//Checkbox for primary,unique and notnull
				...
				writer.println("<TR>");
				//When clicked resets information
				...
				writer.println("</SELECT>");
                                ...
                                //Displaying previous column names
				...
				writer.println("</SELECT>");
                                ...
                                //Displaying previous column index
				...
				writer.println("</SELECT>");
                                ...
                                //Displaying column names of selected table
				writer.println("</TD></TR>");
				writer.println("<TR><TD COLSPAN=2 STYLE='background:#c5d6df;text-align:center'>");
				writer.println(	"<SELECT NAME=column_names MULTIPLE STYLE='width:100%;height:150px' " +
				...
				//When clicked changes name of table
