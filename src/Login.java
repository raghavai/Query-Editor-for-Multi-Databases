...
public class Login extends HttpServlet
{
	public void doGet(HttpServletRequest req, HttpServletResponse res)
		...
		writer.println(	"<STYLE>" +
                ...
                //Java Script for login form where various functions of login form are coded
                writer.println(	"<SCRIPT LANGUAGE=javascript>" +
						...
						"	if(i == 0) 		document.loginform.url.value = \"jdbc:odbc:mydsn\"; " +
						"	else if(i == 1) document.loginform.url.value = \"jdbc:mysql://localhost:3306/mysql\"; " +
						"	else if(i == 2) document.loginform.url.value = \"jdbc:oracle:thin:@localhost:1521:oracle8i\"; " +
						"} " +
						"</SCRIPT>");
		writer.println("</HEAD>");
