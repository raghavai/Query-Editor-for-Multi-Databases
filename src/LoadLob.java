		...
		if(session != null) {
			...
			try {
				...
				statement  = connection.createStatement();				
                                ...
                                //Enabling error_occured if connection faied
				error_occured = true;
			...
			if(!error_occured)	{
				...
				//Updating sorting information of query if any
				...
				try {
					...
					int index = 1;
                                        ...
                                        //Iterating resultset and writing the LOB values
