...
public class BrowseTab extends HttpServlet {
	...
	public void doPost(HttpServletRequest req, HttpServletResponse res)
		...
		if(session == null) {
			...
			//Set Default number of records to 11
			...
			try{	
                                startIndex = Integer.parseInt(req.getParameter("start_index"));	
                        }
			//Set default starting record number to 1
                        catch (NumberFormatException e)	{	
                            startIndex = 1;	
                        }
			...
			//Heap Count 
                        try {	
                            headRepCount = Integer.parseInt(req.getParameter("head_rep_count"));	
                        }
			//Default heap count value as 11
                        catch (NumberFormatException e)	{
                               headRepCount = 11;	
                        }
			...
			if(largeColumnCount > 0)	{
				...
				for(int i=0;i<largeColumnCount;i++)	{
					...
					largeColumnTypes.add(req.getParameter("large_column_type" + i));
                        ...
                        //Loading driver and Establishing a connection
			try {
				...
				error_message = e.toString();
                        ...
                        //Displaying error message when Connection Failed
			if(error_occured) {
